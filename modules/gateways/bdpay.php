...
function bdpay_link($params)
{
    ...
    $css = '<style>
:root{--bk:#e2136e;--ng:#f97316;--rk:#7c3aed;--wa:#16a34a;--em:#4f46e5;--sl:#f8fafc;--bd:#e2e8f0;--tx:#575757;--t2:#64748b;--t3:#94a3b8;}
...
.bdpc{width:100%;max-width:520px;margin:16px;border-radius:6px;background:#fff;background-clip:padding-box;overflow:hidden;box-shadow:0 0 1px rgba(0,0,0,.1),0 2px 4px rgba(0,0,0,.2);border:0;outline:0;font-family:system-ui,sans-serif;font-size:16px;position:relative;transform:translateY(18px) scale(.98);transition:transform .35s cubic-bezier(.34,1.56,.64,1);max-height:92vh;display:flex;flex-direction:column}
.bdpo.on .bdpc{transform:translateY(0) scale(1)}
.bdph{padding:16px 18px 0;background:#fff;border-bottom:1.5px solid var(--bd);flex-shrink:0}
.bdph-top{display:flex;align-items:center;gap:11px;margin-bottom:14px}
.bdph-logo{height:36px;width:auto;border-radius:8px;object-fit:contain}
.bdph-meta{flex:1}
.bdph-title{font-size:16px;font-weight:700;color:var(--tx);margin:0 0 2px}
.bdph-sub{font-size:12px;color:var(--t2);margin:0}
.bdph-close{margin-left:auto;padding:0;background:transparent;border:0;appearance:none;cursor:pointer;font-size:21px;font-weight:700;line-height:1;color:#000;text-shadow:0 1px 0 #fff;opacity:.2;align-self:flex-start;flex-shrink:0}
.bdph-close:hover{opacity:.5}
.bdp-tabs{display:flex}
.bdp-tab{flex:1;padding:9px 8px;border:none;border-bottom:2.5px solid transparent;background:none;color:var(--t3);font-family:inherit;font-size:16px;font-weight:600;cursor:pointer;transition:all .2s;margin-bottom:-1.5px}
...
.bdp-card{border-radius:10px;padding:14px 16px;background:#fff;border:1.5px solid var(--bd)}
...
.bdp-row{padding:8px 0;border-bottom:1px solid var(--bd)}.bdp-row:last-child{border-bottom:none}
.bdp-row-label{font-size:11px;color:var(--t2);margin-bottom:4px}
.bdp-numbox{display:flex;align-items:center;gap:8px;background:var(--sl);border-radius:8px;padding:7px 10px;border:1.5px solid var(--bd)}
...
.bdp-input{width:100%;padding:10px 12px 10px 36px;border:1.5px solid var(--bd);border-radius:10px;box-sizing:border-box;font-size:13px;font-family:inherit;color:var(--tx);background:#fff;transition:all .2s;outline:none}
.bdp-input:focus{border-color:#4f46e5;box-shadow:0 0 0 3px rgba(79,70,229,.1)}
...
.bdp-ico{position:absolute;left:11px;bottom:10px;color:var(--t3);pointer-events:none;line-height:1}
...
.bdp-btn{display:flex;align-items:center;justify-content:center;gap:7px;padding:11px 10px;border:none;border-radius:10px;font-family:inherit;font-size:13px;font-weight:700;color:#fff;cursor:pointer;transition:all .2s}
...
.bdp-foot{text-align:center;font-size:11px;color:var(--t3);margin-top:12px;padding-top:12px;border-top:1.5px solid var(--bd)}
    ...
    <div class="bdpb">
      ...
      <div class="bdp-card" style="margin-top:16px">
        ...
        <div class="bdp-fg">
          ...
          <input type="text" id="bdpay-sender" class="bdp-input" placeholder="Your Account Number e.g. 8801XXXXXXXX">
        </div>
        <div class="bdp-fg" style="margin-bottom:0">
          ...
          <input type="text" id="bdpay-txid" class="bdp-input" placeholder="Enter Transaction ID (TxID)">
        </div>
      </div>
      ...
      <div class="bdp-foot">It may take a few minutes to verify your payment. We&#39;ll notify you once it&#39;s done.</div>
    </div>
  </div>
</div>
